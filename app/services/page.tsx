      ...
      <div className="bg-dark-green py-24 text-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn direction="down">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 uppercase">Landscaping Services</h1>
            <p className="text-xl md:text-2xl text-cream/70 max-w-3xl mx-auto font-medium">
              From precision maintenance to major transformations, we provide a full spectrum of outdoor solutions.
            </p>
          </FadeIn>
        </div>
      </div>
